...
public class ShowBlockedUrlActivity extends Activity implements TimeListner {
    ListView listView;
    int deletePosition;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent intent = new Intent(ShowBlockedUrlActivity.this, BlockUrlActivity.class);
